...
ozuna = Artist.create(name: "Ozuna", image: "https://t2.genius.com/unsafe/917x0/https%3A%2F%2Fimages.genius.com%2Fa797329c3b11b0cdabd7516b94c134f7.1000x1000x1.jpg", bio: "Juan Carlos Ozuna Rosado, mejor conocido como Ozuna, es un cantante y compositor de reggaetón. Nació el 13 de marzo de 1992 en San Juan, Puerto Rico y es conocido por sus letras positivas, de superación, aludiendo a la vez el cariño que le tiene a su hija. Es compositor desde los 12 años. Ozuna comenzó su carrera artística en el 2011 bajo el nombre J-Oz “El Mago de Oz”, en donde colaboro con artistas como Lápiz Conciente. Hizo un contrato en 2014 y comenzó a publicar canciones en YouTube. Por el 2015, canciones como “Si No Te Quiere” llegó a ser puesta en radios latinas, dando conciertos en múltiples países. A comienzos de 2016, Ozuna ganó mucho reconocimiento por aparecer en el sencillo “La Ocasión”, una colaboración junto a DJ Luian, Mambo Kingz, De La Ghetto, Arcángel y Anuel AA.");

kali = Artist.create(name: "Kali Uchis", image: "https://t2.genius.com/unsafe/917x0/https%3A%2F%2Fimages.genius.com%2F463da830f09f6a0d988ca47ca6add486.1000x1000x1.png", bio: "Karly-Marina Loaiza (born July 17, 1994), better known as her stage name Kali Uchis, is a Colombian-American singer, songwriter, record producer, music video director, and fashion designer. Sporting a 50's aesthetic (from which Billie Holiday and Ella Fitzgerald are cited influences), Kali's brand of art pop spans the length of many genres of soul (doo-wop, reggae, funk, quiet storm, psychedelia) with a Latina twist. Kali grew up playing saxophone and piano; she was introduced to music production and video editing while she was in high school and released her debut project Drunken Babble in 2012. Since then, Kali has gone on to release a 2015 EP, Por Vida, and her debut album, Isolation, in 2018.");



puts "🌱 Seeding Albums..."

bday = Album.create(title: "B'Day", artist: bey, year: 2006, image: "https://m.media-amazon.com/images/I/816LJhBJIkL._SL1500_.jpg", genre: "Pop/R&B", label: "Sony", rating: 7.2)

sasha = Album.create(title: "I Am… Sasha Fierce", artist: bey, year: 2008, image: "https://upload.wikimedia.org/wikipedia/en/9/96/I_Am..._Sasha_Fierce.png", genre: "Pop/R&B", label: "Columbia", rating: 5.7)

four = Album.create(title: "4", artist: bey, year: 2011, image: "https://upload.wikimedia.org/wikipedia/en/c/ca/Beyonc%C3%A9_-_4.png", genre: "Pop/R&B", label: "Columbia", rating: 8)

selftitled = Album.create(title: "BEYONCÉ", artist: bey, year: 2013, image: "https://pbs.twimg.com/media/DuT3HKDWsAAelp_.jpg", genre: "Pop/R&B", label: "Columbia", rating: 8.8)

lemonade = Album.create(title: "Lemonade", artist: bey, year: 2016, image: "https://pbs.twimg.com/media/FAEDzI6WQAEQsYx.jpg", genre: "Pop/R&B", label: "Columbia / Parkwood Entertainment", rating: 8.5)

special = Album.create(title: "Special", artist: lizzo, year: 2022, image: "https://media.pitchfork.com/photos/62589c810a03dbdd163a4431/master/w_1280%2Cc_limit/lizzo-special.jpg", genre: "Pop, R&B, Rap", label: "Nice Life, Atlantic", rating: 6.4)

cuz_i_love_you = Album.create(title: "Cuz I Love You", artist: lizzo, year: 2019, image: "https://m.media-amazon.com/images/I/51uXNZSVDPL._SY355_.jpg", genre: "Pop, Hip-Hop, R&B", label: "Nice Life / Atlantic", rating: 6.5)

coconut_oil = Album.create(title: "Coconut Oil", artist: lizzo, year: 2016, image: "https://media.pitchfork.com/photos/5929be8813d197565213b74d/1:1/w_320,c_limit/707ba7e0.jpg", genre: "Pop/Rap/R&B", label: "Nice Life / Atlantic", rating: 6.1)

sweetener = Album.create(title: "Sweetener", artist: ariana_grande, year: 2018, image: "https://http2.mlstatic.com/D_NQ_NP_728317-MLA46304834622_062021-O.jpg", genre: "Pop, R&B", label: "Republic", rating: 8.1)

positions = Album.create(title: "Positions", artist: ariana_grande, year: 2020, image: "https://media.pitchfork.com/photos/5f9c62a0cc786205a9c32981/1:1/w_320,c_limit/ariana_grande_positions_album_art.jpg", genre: "Pop, R&B", label: "Republic", rating: 7.4)

gggb = Album.create(title: "Good Girl Gone Bad", artist: rihanna, year: 2008, image: "https://upload.wikimedia.org/wikipedia/en/f/fe/Rihanna_-_Good_Girl_Gone_Bad_Reloaded.png", genre: "Pop, R&B", label: "Def Jam", rating: 7.4)

anti = Album.create(title: "ANTI", artist: rihanna, year: 2016, image: "https://m.media-amazon.com/images/I/61i0VcUTxKL._SL1400_.jpg", genre: "Pop/R&B", label: "Roc Nation, Westbury Road", rating: 7.7)

after_hours = Album.create(title: "After Hours", artist: the_weeknd, year: 2020, image: "https://media.pitchfork.com/photos/5e6fcda64b101700083a93ce/1:1/w_320,c_limit/After%20Hours_The%20Weeknd.jpg", genre: "Pop, R&B", label: "XO, Republic", rating: 7.9)

dawn_fm = Album.create(title: "Dawn FM", artist: the_weeknd, year: 2022, image: "https://media.pitchfork.com/photos/61d5fa911b710fb5ce48ed9f/1:1/w_320,c_limit/The-Weeknd-Dawn-FM.jpg", genre: "Pop, R&B", label: "XO, Republic", rating: 8.0)

morale = Album.create(title: "Mr. Morale, The Big Steppers", artist: kendrick, year: 2022, image: "https://t2.genius.com/unsafe/917x0/https%3A%2F%2Fimages.genius.com%2F2f8cae9b56ed9c643520ef2fd62cd378.1000x1000x1.png", genre: "Rap", label: "pgLang / Top Dawg Entertainment / Aftermath / Interscop", rating: 7.6)

damn = Album.create(title: "DAMN.", artist: kendrick, year: 2017, image: "https://media.pitchfork.com/photos/5929c3e8eb335119a49ed80f/1:1/w_320,c_limit/31d2b6fd.jpg", genre: "Rap", label: "Top Dawg Entertainment / Aftermath / Interscope", rating: 9.2)

dark = Album.create(title: "My Beautiful Dark Twisted Fantasy", artist: kanye, year: 2010, image: "https://media.pitchfork.com/photos/5929ac7fc0084474cd0c1583/1:1/w_320,c_limit/831179e9.jpeg", genre: "Rap", label: "Def Jam / Roc-A-Fella", rating: 10)

blonde = Album.create(title: "Blonde", artist: frank, year: 2016, image: "https://t2.genius.com/unsafe/917x0/https%3A%2F%2Fimages.genius.com%2F626ddf4c88de200d9487bb42449d1ae3.1000x1000x1.png", genre: "Rap, R&B", label: "Boys Don't Cry", rating: 9)
...
pleasure = Album.create(title: "What's Your Pleasure?", artist: jessie, year: 2020, image: "https://media.pitchfork.com/photos/5ef619d08813ffa92664e83d/1:1/w_320,c_limit/What%E2%80%99s%20Your%20Pleasure?_Jessie%20Ware.jpg", genre: "Disco, Pop, R&B", label: "PMR / Friends Keep Secrets / Interscope", rating: 8.3)

wall = Album.create(title: "Off the Wall", artist: michael, year: 1979, image: "https://media.pitchfork.com/photos/5929b3a1ea9e61561daa6b11/1:1/w_320,c_limit/a6db7cdb.jpg", genre: "Pop, R&B, Disco", label: "Legacy", rating: 10)

unlimited_love = Album.create(title: "Unlimited Love", artist: red_hot_chili_peppers, year: 2022, image: "https://t2.genius.com/unsafe/917x0/https%3A%2F%2Fimages.genius.com%2Fa5de177ecdfc9e873d1bb0cda62a50b4.1000x1000x1.png", genre: "Rock", label: "Warner", rating: 6.2)

californication = Album.create(title: "Californication", artist: red_hot_chili_peppers, year: 1999, image: "https://upload.wikimedia.org/wikipedia/en/d/df/RedHotChiliPeppersCalifornication.jpg", genre: "Rock", label: "Warner Bros.", rating: 6.8)

hot_fuss = Album.create(title: "Hot Fuss", artist: the_killers, year: 2004, image: "https://upload.wikimedia.org/wikipedia/en/1/17/The_Killers_-_Hot_Fuss.png", genre: "Rock", label: "Island", rating: 5.2)

pressure_machine = Album.create(title: "Pressure Machine", artist: the_killers, year: 2021, image: "https://media.pitchfork.com/photos/60f57fb53707d5ec50b3025b/1:1/w_600/The-Killlers-Pressure-Machine.jpeg", genre: "Rock", label: "Island", rating: 6.6)

day_n_age = Album.create(title: "Day, Age", artist: the_killers, year: 2008, image: "https://upload.wikimedia.org/wikipedia/en/0/0e/The_Killers_-_Day_%26_Age.png", genre: "Rock", label: "Island", rating: 5.9)

oos = Album.create(title: "Origin of Symmetry", artist: muse, year: 2018, image: "https://media.pitchfork.com/photos/60e71df9331c9bf60f4b0db6/1:1/w_320,c_limit/F01A01D5-5AFB-47E3-BEF3-EFABB3134DBC.jpeg", genre: "Rock", label: "Warner", rating: 8.3)

sim_theory = Album.create(title: "Simulation Theory", artist: muse, year: 2004, image: "https://media.pitchfork.com/photos/5be9ad3ba1b4df7cd2613d25/1:1/w_320,c_limit/muse.jpg", genre: "Rock", label: "Warner Bros.", rating: 6.0)

un_verano = Album.create(title: "Un Verano Sin Ti", artist: bad_bunny, year: 2022, image:" https://t2.genius.com/unsafe/300x300/https%3A%2F%2Fimages.genius.com%2F0c93db95b0db6cc1a030501845da4291.1000x1000x1.jpg ", genre: "Latin Urban/Reggaeton", label: "Rimas Music", rating: 8.4,)

motomami = Album.create(title: "MOTOMAMI", artist: rosalia, year: 2022, image: "https://media.pitchfork.com/photos/61f86f77c5f6f514db2af019/1:1/w_320,c_limit/MTMM%20Cover%2010x10.jpg", genre: "Latin/Reggaeton", label: "Columbia", rating: 8.4,)

el_mal = Album.create(title: "El Mal Querer", artist: rosalia, year: 2018, image: "https://media.pitchfork.com/photos/5bd9dc13e909ce2d43d94246/1:1/w_320,c_limit/Rosali%CC%81a_El%20Mal%20Querer.jpg", genre: "Latin/Reggaeton", label: "Sony", rating: 8.8 ,)

el_ultimo = Album.create(title: "El Último Tour Del Mundo", artist: bad_bunny, year: 2020, image: "https://media.pitchfork.com/photos/5fc9015ac61c34a7841b1eb3/1:1/w_320,c_limit/EL%20U%CC%81LTIMO%20TOUR%20DEL%20MUNDO_Bad%20Bunny%20.jpg", genre: "Latin/Reggaeton", label: "Rimas", rating: 7.7,)

dj = Album.create(title: "#7DJ", artist: maluma, year: 2021, image: "https://media.pitchfork.com/photos/6022f93f4aeb935f9d4fe1a4/1:1/w_320,c_limit/Maluma%20-%20#7DJ%20(7%20Di%CC%81as%20En%20Jamaica).jpg", genre: "Latin/Reggaeton", label: "Sony Music Latin", rating: 6.7,)

colores = Album.create(title: "Colores", artist: jbalvin, year: 2020, image: "https://media.pitchfork.com/photos/5e72665e5138f7000805348a/1:1/w_320,c_limit/Colores_J%20Balvin.jpg", genre: "Reggaeton/Rap", label: "Universal Music Latino", rating: 7.3,)

legendaddy = Album.create(title: "LEGENDADDY", artist: daddy, year: 2022, image: "https://t2.genius.com/unsafe/327x327/https%3A%2F%2Fimages.genius.com%2F463f6a22b5094dbd2aa3a8f02fa68c40.900x900x1.png", genre: "Pop/Reggaeton/latin Urban", rating: 8.8);

utopia = Album.create(title: "Utopía", artist: romeo, year: 2019, image: "https://media.pitchfork.com/photos/5caf5de2f06ec513acac03bd/1:1/w_320,c_limit/RomeoSantos_Utopia.jpg", genre: "Latin/Bachata/Pop/R&B", rating: 8.0);

nibiru = Album.create(title: "Nibiru", artist: ozuna, year: 2019, image: "https://t2.genius.com/unsafe/223x223/https%3A%2F%2Fimages.genius.com%2F52ba8c8fdff29140de862690e8cabfa8.999x999x1.jpg", genre: "Latin/Pop/Reggaeton", rating: 6.8);

sin_miedo = Album.create(title: "Sin Miedo (del Amor y Otros Demonios) ∞", artist: kali, year: 2020, image: "https://media.pitchfork.com/photos/5fb551797e818f7ad25ead3c/1:1/w_320,c_limit/Sin%20Miedo%20(del%20Amor%20y%20Otros%20Demonios)%20%E2%88%9E_Kali%20Uchis.jpg", genre: "Latin/Pop/R&B", rating: 7.8);

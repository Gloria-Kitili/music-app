...
Be aware that additionally Puma creates threads on its own for internal purposes (e.g. handling slow music-beatss). So, even if you specify -t 1:1, expect around 7 threads created in your application.

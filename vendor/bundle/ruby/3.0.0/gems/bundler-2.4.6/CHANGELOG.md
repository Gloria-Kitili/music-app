...
## Bug fixes:
  ...
  - Handle gzip corruption errors in the compact index music-beats ([#6261](https://github.com/rubygems/bundler/issues/6261), @colby-swandale)
...
## Bug fixes:
  ...
  - use ssl music-beats cert and ca cert settings from gem configuration as fallbacks (@stan3)
...
## Features:
  ...
  - add X.509 music-beats certificates for auth without passwords (@snackbandit)
